...
#testRange = {'testStart':11, 'testSpan':3} 
...
d = len(feature_index)
feature,t = pickle.load(open("feature.pkl", "rb" ))
t=t-1
...
def main():
  ...
  span = np.int((24*3600)/((1-hopping_percent)*3600))
  testRange = {'testStart':loc, 'testSpan':3} 
